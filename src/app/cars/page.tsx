...
export default async function Cars(){
  ...
  return(
    <div className="flex flex-col m-8 gap-y-4">
      ...
      <form action={createCar} className="flex flex-col gap-y-2">
        <input className='text-black' type="text" placeholder="Nome" name='name'/>
        <input  className='text-black' type="text" placeholder="brand" name='brand' />
